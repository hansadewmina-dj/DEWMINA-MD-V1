...
global.location = "Srilanka, Biyagama";
...
global.gurl = process.env.GURL || "https://www.youtube.com/@DJ_Dewmina";
global.website = process.env.GURL || "https://www.youtube.com/@DJ_Dewmina";
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://imgur.com/a/jZ3aGrt";
global.devs = "https://www.youtube.com/@DJ_Dewmina";
...
global.userImages = process.env.USER_IMAGES || "https://imgur.com/a/jZ3aGrt";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "`DEWMINA_MD-V1™`",
  author: process.env.PACK_AUTHER || "DEWMINA_MD-V1",
  packname: process.env.PACK_NAME || "D E W M I N A",
  botname: process.env.BOT_NAME || "DEWMINA_MD-V1",
  ...
  LANG: (process.env.THEME || "D E W M I N A").toUpperCase(),
};
global.rank = "updated";
